...
const dictionaries = {
  en: { home: "Home", services: "Services", conditions: "Conditions", about: "About", contact: "Contact", book: "Book appointment", call: "Call", whatsapp: "WhatsApp us", directions: "Directions", heroEyebrow: "Physiotherapy & rehabilitation · Manish Nagar, Nagpur", heroStart: "Care that gets you", heroEm: "moving again.", heroCopy: "Osteopathy, Matrix Rhythm Therapy, dry needling, Tecar & laser therapy and Pilates — personalised by Dr. Priyanka Chaitanya Helwatkkar.", openDays: "Open 7 days", concerns: "How can we help?", hours: "Hours", address: "Address", fullName: "Full name", mobile: "Mobile number", service: "Service", date: "Preferred date", time: "Time window", note: "A note for the clinic", consent: "I agree to be contacted about my appointment", submit: "Send appointment request", footer: "Helping Nagpur move better." },
