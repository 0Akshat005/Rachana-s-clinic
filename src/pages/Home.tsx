        ...
        >
          ...
          >
            <div className="flex flex-col items-center">
              ...
              <h3 className="mt-6 text-center font-display text-[22px] font-bold leading-[1.24] tracking-[-0.01em] text-[#0E1C38] transition-colors duration-200 group-hover:text-[#172D56]">
                {service.title}
              </h3>
